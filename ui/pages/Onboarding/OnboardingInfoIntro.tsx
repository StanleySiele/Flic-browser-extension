...
const steps = [
  {
    ...
    title: "Welcome to Flic!",
    body: "A web3 App Extension.",
    buttonCopy: "Continue",
  },
  {
    image: {
    ...
    title: "Use it to Register",
    body: `You can register a new account using this extension`,
    buttonCopy: "Continue",
  },
  {
    image: {
    ...
    title: "Be safe",
    body: `Do not send funds to addresses you are unsure of.`,
    buttonCopy: "Continue",
  },
  {
    image: {
    ...
    title: "Use Flic as default",
    body: `You can use this app as the default web3 extension`,
